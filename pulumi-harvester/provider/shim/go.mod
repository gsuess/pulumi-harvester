module github.com/harvester/terraform-provider-harvester/shim
...
require (
	github.com/harvester/terraform-provider-harvester v0.6.2
...
require (
	...
	github.com/harvester/harvester v1.1.1 // indirect
